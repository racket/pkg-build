...
(define main-dist-bin-pkgs
  (list "com-win32-i386" "com-win32-x86_64"
        "db-ppc-macosx" "db-win32-i386"
        "db-win32-x86_64" "db-win32-x86_64-2"
        "db-win32-arm64" "db-win32-arm64-2"
        ...
        "draw-win32-x86_64" "draw-win32-x86_64-2" "draw-win32-x86_64-3" "draw-win32-x86_64-4"
        "draw-win32-arm64-3" "draw-win32-arm64-4"
        ...
        "racket-win32-x86_64" "racket-win32-x86_64-2" "racket-win32-x86_64-3" "racket-win32-x86_64-4"
        "racket-win32-arm64-3" "racket-win32-arm64-4"
